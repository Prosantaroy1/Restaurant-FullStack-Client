        ...
        <div className="flex">
            <div className="w-64 pt-4 min-h-screen text-white bg-orange-500">
                ...
                <ul className="flex justify-center items-center flex-col gap-4">
                    {
                        isAdmin ? <>
                            <li className="hover:bg-green-400 rounded-lg py-1 px-2 w-full"><NavLink to='/dashboard/adminhome' className='flex items-center gap-1'><CiHome />  Admin Home</NavLink></li>
                            <li className="hover:bg-green-400 rounded-lg py-1 px-2 w-full"><NavLink className='flex items-center gap-1' ><IoMdCart /> Add Item</NavLink></li>
                            <li className="hover:bg-green-400 rounded-lg py-1 px-2 w-full"><NavLink className='flex items-center gap-1'> <IoMdCart />  Manage ITem</NavLink></li>
                            <li className="hover:bg-green-400 rounded-lg py-1 px-2 w-full"><NavLink className='flex items-center gap-1'> <TbBrandBooking />  Manage booking</NavLink></li>
                            <li className="hover:bg-green-400 rounded-lg py-1 px-2 w-full"><NavLink to='/dashboard/user' className='flex items-center gap-1'> <VscPreview />  All User</NavLink></li>
                        </> : <>
